...
function randomPosition() {
    const x = Math.floor(Math.random() * (gameContainer.clientWidth - blueBox.clientWidth));
    const y = Math.floor(Math.random() * (gameContainer.clientHeight - blueBox.clientHeight));
    return { x, y };
}
